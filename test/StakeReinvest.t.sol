...
contract StakeReinvestTest is Test {
    ...
    function test_SlippageProtection() public {
        ...
        // Set a higher min output percentage that router can't satisfy (95% when router only returns 50%)
        vm.prank(owner);
        ...
        // Should revert because the min output requirement can't be met
        vm.expectRevert();
        stake.reinvest();
